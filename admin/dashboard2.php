        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="card">
                    ...
                    <ul class="list-inline">
                        <li class="list-inline-item">
                            <a class="text-xs-center" href="homefuncionario.php?op=listar&pg=buscapreco">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="card">
                    ...
                    <ul class="list-inline">
                        <li class="list-inline-item">
                            <a class="text-xs-center" href="homefuncionario.php?op=pedido&pg=pedido">
                                <i class="fa fa-angle-up"></i>
                                <label for="ir"><b> Abrir </b></label>
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a class="text-xs-center" href="homefuncionario.php?op=listar&pg=pedido">
                                <i class="fa fa-search"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="card">
                    <p><img class=" img-fluid" src="../arquivos/imagens/cliente.png" alt="card image"></p>
                    <h4 class="card-title"><b>Cliente</b></h4>
                    <hr>
                    <ul class="list-inline">
                        <li class="list-inline-item">
                            <a class="text-xs-center" href="homefuncionario.php?op=cadastrar&pg=cliente">
                                <i class="fa fa-angle-up"></i>
                                <label for="ir"><b> Abrir </b></label>
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a class="text-xs-center" href="homefuncionario.php?op=listar&pg=cliente">
                                <i class="fa fa-search"></i>
                                <label for="ir"><b> Buscar </b></label>
                            </a>
                        </li>
...
<style>
    .mesa-ocupada {c
        box-shadow: red 4px 5px 11px;
        padding: 10px;
        margin-top: 0 !important
    }

    .mesa-livre {
        box-shadow: green 4px 5px 11px;
        padding: 10px;
        margin-top: 0 !important
    }
</style>
                            ...
                            if ($dados->status == "D") {
                                ...
                                <div class="card mesa-livre" id="mesa">
                                    ...
                                    <div class="card-footer mt-2"> 
                                        <a class="btn btn-outline-primary" href="homefuncionario.php?op=pedido&pg=pedido&idmesa=' . $idmesa . '"> 
...
<script>
    function crtz(idpedido) {
        ...
        if (r == true) {
            window.location.href="homefuncionario.php?op=pedido&pg=checkout&idpedido="+idpedido;
        } 
    }
</script>